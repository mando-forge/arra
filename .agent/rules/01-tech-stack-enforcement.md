...
- **Enforced Preset:** The project relies on a strictly locked shadcn environment. If UI initialization is required, use exactly: `npx shadcn@latest init --preset b2p86qOxM --template vitetemplate`.
